...
----
include::src/main/java/dev/sharanggupta/gs_relational_data_access/Customer.java[]
----
====
...
[source,java,tabsize=2]
----
include::src/main/java/dev/sharanggupta/gs_relational_data_access/GsRelationalDataAccessApplication.java[]
----
====
